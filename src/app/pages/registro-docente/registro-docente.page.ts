...
export class RegistroDocentePage implements OnInit {
  ...
  Enviar(): void {
    this.docente.nombre = this.loginForm.value.nombre;
    this.docente.correo = this.loginForm.value.correo;
    this.docente.contrasena = this.loginForm.value.contrasena;
    this.docente.jornada = this.loginForm.value.jornada;


    const asignaturasFormArray = this.loginForm.get('asignaturas') as FormArray;
  
    
    this.docente.asignaturas = asignaturasFormArray.value;
